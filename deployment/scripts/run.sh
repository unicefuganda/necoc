...
sed -i "s/##API_AUTHORIZED_STEP##/$API_AUTHORIZED_STEP/g" /etc/uwsgi/apps-enabled/necoc-uwsgi.ini
sed -i "s/##API_AUTHORIZED_STEP##/$API_AUTHORIZED_STEP/g" /etc/supervisor/conf.d/supervisor.conf
